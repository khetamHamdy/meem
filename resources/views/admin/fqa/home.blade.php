        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div>
                    ...
                    <a href="{{url(getLocal().'/admin/fqa/create')}}" class="btn btn-secondary  mr-2 btn-success">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover tableWithSearch" id="tableWithSearch">
                                ...
                                <tr>
                                    ...
                                    <th class="wd-25p"> {{ucwords(__('cp.order'))}}</th>
                                ...
                                @forelse($items as $one)
                                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                                        ...
                                        <td class="v-align-middle wd-25p">{!! $one->order !!}</td>
                                        ...
                                        <td class="v-align-middle wd-15p optionAddHours">
                                            <a href="{{url(getLocal().'/admin/fqa/'.$one->id.'/edit')}}"
